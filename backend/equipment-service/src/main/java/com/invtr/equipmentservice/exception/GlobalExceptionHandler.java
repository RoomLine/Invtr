...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ConditionLogNotFoundException.class)
    public ResponseEntity<Map<String, Object>> handleConditionLogNotFound(ConditionLogNotFoundException ex) {
        return buildResponse(HttpStatus.NOT_FOUND, ex.getMessage());
    }
