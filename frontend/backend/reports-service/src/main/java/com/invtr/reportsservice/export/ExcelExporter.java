...
public class ExcelExporter {
    ...
    public byte[] exportExcelEquipment(List<EquipmentResponse> equipment) throws IOException {
        ...
        try {
            ...
            for (EquipmentResponse e : equipment) {
                ...
                row.createCell(1).setCellValue(e.getName() != null ? e.getName() : "");
                row.createCell(2).setCellValue(e.getType() != null ? e.getType() : "");
                row.createCell(3).setCellValue(e.getStatus() != null ? e.getStatus() : "");
                row.createCell(4).setCellValue(e.getCondition() != null ? e.getCondition() : "");
                row.createCell(5).setCellValue(e.getLocation() != null ? e.getLocation() : "");
            ...
            for (int i = 0; i < 8; i++) sheet.setColumnWidth(i, 256 * 22);
    ...
    public byte[] exportExcelRequests(List<RequestResponse> requests) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < 10; i++) sheet.setColumnWidth(i, 256 * 22);
    ...
    public byte[] exportExcelUsage(List<UsageReportResponse> usageReports) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < 3; i++) sheet.setColumnWidth(i, 256 * 22);
    ...
    public byte[] exportExcelHistory(HistoryReportResponse history) throws IOException {
        ...
        try {
            ...
            for (int i = 0; i < 11; i++) sheet.setColumnWidth(i, 256 * 22);
